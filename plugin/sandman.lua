...
vim.api.nvim_create_user_command('SandmanSetup', function()
  ...
  vim.notify('Please call require("sandman").setup() from your init.lua instead', vim.log.levels.WARN)
end, {
...
vim.api.nvim_create_user_command('SandmanPickBlock', function()
  ...
  if has_telescope then
    ...
    vim.notify('Telescope is required for this command', vim.log.levels.WARN)
  end
end, {
